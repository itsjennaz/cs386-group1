...
![Home page layout sample](https://github.com/colinvwood/AlertX/site/public/image/"home_page_sample.jpg")

As for the product pages we choose one to showcase for layout purposes.

![Product page layout sample](https://github.com/colinvwood/AlertX/site/public/image/"product_page_sample.jpg")
