...
Our software offers a fighting chance to all shoppers. We have an intuitive, clean interface that presents information about products and their stock status to users. Using the system, users are able to customize for which products they want to recieve notifcations. This is a free and easy way to stay in the know about what is in stock online. After the user selects the desired products, they can personalize their notifications. They can select whether they would prefer SMS notifications, email notifications, or both. People who do not want to be bothered on their cell phone can choose email, and people who value the speed and convienence of a text message have the option.

The central requirement of our system is is that restock notifications that are are accurate and up to date with the current market. To this end, some form of automation must be performed regularly to update that statuses of all tracked products.  
